    ...
    <div class="container mt-5">
        <main class="container" style="margin-top: 50px;">
            <div class="col-md-12 col-lg-12">
                <h4 class="mb-3">SIGN UP USER</h4>
                <form class="needs-validation" novalidate="" action="./includes/signup.inc.php" method="post">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="password" class="form-control" name="confirmPassword" id="username"
                                    placeholder="Confirm Password" required="">
                                <div class="invalid-feedback">
                                    Your confirmpassword is required.
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
